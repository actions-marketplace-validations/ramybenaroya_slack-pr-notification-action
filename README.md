...
![example](https://raw.githubusercontent.com/ramybenaroya/slack-pr-notification-action/images/example.png)
...
jobs:
  build:
    ...
    - name: Notify slack pr open
      ...
      uses: ramybenaroya/slack-pr-notification-action@v0.0.1
```
...
![make_pretty](https://raw.githubusercontent.com/ramybenaroya/slack-pr-notification-action/images/make_pretty.png)

#### MAKE_COMPACT
**boolean (DEFAULT: false)**  
Smaller visual footprint.

![make_compact](https://raw.githubusercontent.com/ramybenaroya/slack-pr-notification-action/images/make_compact.png)
